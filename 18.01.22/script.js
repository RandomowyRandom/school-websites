...
triangleButton.addEventListener("click", (e) => {
  ...
  if (
    !Number.isInteger(Number(num1.value)) ||
    !Number.isInteger(Number(num2.value)) ||
    !Number.isInteger(Number(num3.value))
  ) {
    triangleOutput.innerHTML = "Wprowadź liczby całkowite";
    return;
  }
